...
class BookingControllerTest {
    ...
    public void createItem_ReturnsBookingOutputDto() throws Exception {
        ...
        LocalDateTime start = LocalDateTime.parse(LocalDateTime.now().plusHours(10).format(formatter));
        LocalDateTime end = LocalDateTime.parse(LocalDateTime.now().plusDays(2).format(formatter));
